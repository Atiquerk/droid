...
public class shome extends AppCompatActivity {
    ...
    private SApiInterface apiInterface;
    private RecyclerAdapter adapter;
    private int page_number=1;
    private String item_count="sone";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      stermname=findViewById(R.id.stex);
     Intent intent = getIntent();
       String sid=intent.getStringExtra("sname");
      stermname.setText("Search for: "+sid);
      item_count=sid;
      ...
      ringlink=findViewById(R.id.ringlink);
        ringlink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(shome.this, home.class);
        ...
        catmenulink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(shome.this, category.class);
        ...
        searchview.setOnQueryTextListener(new androidx.appcompat.widget.SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                //do here
                if(query.length()>3) {
                    Intent intent = new Intent(shome.this, shome.class);
                    intent.putExtra("sname", query+"");
                    startActivity(intent);
                }else{
                    Toast.makeText(shome.this, "Search phrase at least of 4 characters.", Toast.LENGTH_LONG).show();
                }
                return true;
            }
...
//
        ...
        apiInterface=SApiClient.getAPIClient().create(SApiInterface.class);
        ...
        call.enqueue(new Callback<List<DataResponse>>() {
            ...
            public void onResponse(Call<List<DataResponse>> call, Response<List<DataResponse>> response) {
                ...
                adapter=new RecyclerAdapter(rings,shome.this,bottombar,play,stop,mediaplayer,seekBar,handler,ringname);
    ...
    public void showmenu(View v){
        PopupMenu popupMenu=new PopupMenu(shome.this,v);
